  ...
  return (
    <div className="filter_menu" style={{ top: props.top + "px", right: props.right + "px" }}>
      ...
      <MenuSection title="Modèle">
        <SelectionSection callback={handleForm} name="modele" selection_origin={modeles} />
      </MenuSection>

      <MenuSection title="Types">
        <SelectionSection callback={handleForm} name="types" selection_origin={types} />
      </MenuSection>

      <MenuSection title="Couleurs">
        <SelectionSection callback={handleForm} name="couleurs" selection_origin={colors} />
      </MenuSection>
      ...
      <MenuSection title="Date de publication">
        <DateSection clear={clearMe} callback={handleForm} name="dates" />
      </MenuSection>

      <MenuSection title="Etat voiture">
        <PriceRangeSection clear={clearMe} callback={handleForm} min={0} max={10} unit="" name="etats" diff={1} />
      </MenuSection>
